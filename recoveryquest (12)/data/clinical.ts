...
export const WELLNESS_STRATEGIES_DB: Record<string, Record<string, WellnessStrategyContent>> = {
  ...
  'Financial': { low: { rangeLabel: 'Low', narrative: 'Stressed.', strategies: ['Budget', 'Save'] }, mid: { rangeLabel: 'Mid', narrative: 'Stable.', strategies: ['Review goals'] }, high: { rangeLabel: 'High', narrative: 'Secure.', strategies: ['Invest'] } },
